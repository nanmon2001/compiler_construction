...
tree.c      - Syntax/type tree maintenance
tree.h      - Definitions for tree.c
encode.c    - Syntax/type tree evaluation, generating the assembly code by calling backend routines
encode.h    - Definitions for encode.h
